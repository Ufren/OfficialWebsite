...
const ScrollProgressBar: React.FC = () => {
  ...
  return (
    <motion.div
      className="fixed top-0 left-0 right-0 h-[2px] bg-[var(--color-text-primary)] origin-left z-[100]"
      style={{ scaleX }}
    />
  );
};
...
export const DeepDive: React.FC = () => {
  ...
  const leftCardY = useTransform(scrollYProgress, [0, 0.5], [80, -30]);
  const rightCardY = useTransform(scrollYProgress, [0, 0.5], [120, -30]);

  const leftCardOpacity = useTransform(scrollYProgress, [0, 0.25, 0.6], [0, 1, 1]);
  const rightCardOpacity = useTransform(scrollYProgress, [0.1, 0.35, 0.7], [0, 1, 1]);
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <motion.div
                style={{ y: leftCardY, opacity: leftCardOpacity }}
                className="relative"
              >
                <motion.div
              ...
              <motion.div
                style={{ y: rightCardY, opacity: rightCardOpacity }}
                className="relative"
              >
                <motion.div
                  whileHover={{ scale: 1.02 }}
